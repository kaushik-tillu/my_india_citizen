...
class AdminStatusList extends StatefulWidget {
  @override
  _AdminStatusListState createState() => _AdminStatusListState();
}

class _AdminStatusListState extends State<AdminStatusList> {
                        ...
                        child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    "Phone Number: ${querySnapshot.docs[i].data()['phonenum']}"),
                                SizedBox(
                                  height: 5.0,
                                ),
                                Text(
                        ...
                        children: <Widget>[
                          ...
                          FlatButton(
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(4.0)),
                            onPressed: () {
                              var update = querySnapshot.docs[i].id;
                              work
                                  .doc(update)
                                  .update({'work': true}).runtimeType;
