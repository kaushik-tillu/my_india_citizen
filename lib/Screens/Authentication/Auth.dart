...
import 'package:my_india_citizen/Screens/Authentication/views/adminAuth.dart';
import 'package:my_india_citizen/Screens/HomeMenuPages/views/adminHome.dart';
    ...
    return Provider(
      ...
      child: MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          ...
          '/adminAuth': (BuildContext context) => AdminAuth(),
          '/adminHome': (BuildContext context) => AdminHome(),
          // '/municipalAuth': (BuildContext context) => MunicipalAuth(),
          // '/municipalHome': (BuildContext context) => MunicipalHome(),
        },
      ),
    );
  }
